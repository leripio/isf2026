...
footer: '46th International Symposium on Forecasting · June 30, 2026. Montréal, Canada · Built with Quarto <iconify-icon icon="simple-icons:quarto" style="display: inline-block; width: 0.9em; height: 0.9em; margin-left: 0.3em; vertical-align: -0.1em;"></iconify-icon>'
format:
  revealjs:
...
### FGV Monitor is difficult to outperform for some components, but less informative for others
